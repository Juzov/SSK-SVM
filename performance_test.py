...
amount_of_documents_list = [100,100,100,100] 
...
data_file_lambda = open(path + '/tests/' + filename, 'w+')
data_file_cache = open(path + '/tests/' + filename, 'w+')
data_file = data_file_lambda
